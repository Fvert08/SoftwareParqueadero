...
class PaginaReportes(QWidget):
    ...
    def initUI(self):
        ...
        titulo_casilleros.setStyleSheet(LABELS['reportes_titulo_casilleros'])
        ...
        linea_horizontal1.setStyleSheet(LINEAS['reportes_linea_horizontal1'])
        layout_reportes.addWidget(linea_horizontal1, 1, 0, 1, 7)
        #Titulo
        titulo_tablaReportes = QLabel('Historial de reportes')
        titulo_tablaReportes.setStyleSheet(LABELS['reportes_titulo_tabla_reportes'])
        ...
        self.tabla_registros.setStyleSheet(TABLAS['reportes_tabla_registros'])
        ...
        boton_reimprimir.setStyleSheet(
            BOTONES['reportes_boton_reimprimir'])
        ...
        label_desde.setStyleSheet(LABELS['reportes_label_desde'])
        layout_reportes.addWidget(label_desde, 10, 0, 1, 1, alignment=Qt.AlignHCenter | Qt.AlignCenter)
       # Date desde
        self.date_desde = QDateEdit()
        self.date_desde.setStyleSheet(OTROS['reportes_date_desde'])
        ...
        calendarDesde_widget.setStyleSheet(CALENDARIOS['reportes_calendar_desde_widget']) 
        calendarDesde_widget.setStyleSheet(CALENDARIOS['reportes_calendar_desde_widget_2'])
        ...
        label_hasta.setStyleSheet(LABELS['reportes_label_hasta'])
        layout_reportes.addWidget(label_hasta, 10,2, 1, 1, alignment=Qt.AlignHCenter | Qt.AlignCenter)
       # Date hasta
        self.date_hasta = QDateEdit()
        self.date_hasta.setStyleSheet(OTROS['reportes_date_hasta'])
        ...
        calendarhasta_widget.setStyleSheet(CALENDARIOS['reportes_calendarhasta_widget']) 
        calendarhasta_widget.setStyleSheet(CALENDARIOS['reportes_calendarhasta_widget_2'])
        ...
        boton_imprimir.setStyleSheet(
            BOTONES['reportes_boton_imprimir'])
        ...
        boton_Resumen.setStyleSheet(
            BOTONES['reportes_boton_resumen'])
