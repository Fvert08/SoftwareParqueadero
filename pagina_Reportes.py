...
class PaginaReportes(QWidget):
    ...
    def initUI(self):
        ...
        titulo_casilleros.setStyleSheet(STYLES['pagina_Reportes.py:94'])
        ...
        linea_horizontal1.setStyleSheet(STYLES['pagina_Reportes.py:101'])
        layout_reportes.addWidget(linea_horizontal1, 1, 0, 1, 7)
        #Titulo
        titulo_tablaReportes = QLabel('Historial de reportes')
        titulo_tablaReportes.setStyleSheet(STYLES['pagina_Reportes.py:105'])
        ...
        self.tabla_registros.setStyleSheet(STYLES['pagina_Reportes.py:113'])
        ...
        label_desde.setStyleSheet(STYLES['pagina_Reportes.py:199'])
        layout_reportes.addWidget(label_desde, 10, 0, 1, 1, alignment=Qt.AlignHCenter | Qt.AlignCenter)
       # Date desde
        self.date_desde = QDateEdit()
        self.date_desde.setStyleSheet(STYLES['pagina_Reportes.py:203'])
        ...
        calendarDesde_widget.setStyleSheet(STYLES['pagina_Reportes.py:210']) 
        calendarDesde_widget.setStyleSheet(STYLES['pagina_Reportes.py:211'])
        ...
        label_hasta.setStyleSheet(STYLES['pagina_Reportes.py:217'])
        layout_reportes.addWidget(label_hasta, 10,2, 1, 1, alignment=Qt.AlignHCenter | Qt.AlignCenter)
       # Date hasta
        self.date_hasta = QDateEdit()
        self.date_hasta.setStyleSheet(STYLES['pagina_Reportes.py:221'])
        ...
        calendarhasta_widget.setStyleSheet(STYLES['pagina_Reportes.py:229']) 
        calendarhasta_widget.setStyleSheet(STYLES['pagina_Reportes.py:230'])
