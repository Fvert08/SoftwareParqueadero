...
class MiVentana(QWidget):
    ...
    def initUI(self):
        ...
        self.setStyleSheet(OTROS['principal_ventana'])
    ...
    def Pagina_principal(self):
        ...
        self.menu_label.setStyleSheet(LABELS['principal_menu_label'])
        ...
        self.line_frame2.setStyleSheet(LINEAS['principal_line_frame2'])
        layout_menu.addWidget(self.line_frame2, alignment=Qt.AlignTop)

        self.botonRegistros = QPushButton('Registro de ingresos', self)
        self.botonRegistros.setStyleSheet(BOTONES['principal_boton_registros'])
        ...
        self.botontickets.setStyleSheet(BOTONES['principal_botontickets'])
        ...
        self.botonGestionarCasilleros.setStyleSheet(BOTONES['principal_boton_gestionar_casilleros'])
        ...
        self.botonReportes.setStyleSheet(BOTONES['principal_boton_reportes'])
        ...
        self.botonConfiguracion.setStyleSheet(BOTONES['principal_boton_configuracion'])
        ...
        self.botonConCreditos.setStyleSheet(BOTONES['principal_boton_con_creditos'])
        ...
        if self.diasSuscripcion() <= 0:
            ...
            self.botonConfiguracion.setStyleSheet(BOTONES['principal_boton_configuracion_2'])
            self.botonRegistros.setStyleSheet(BOTONES['principal_boton_registros_2'])
        else:
    ...
    def cambiar_color(self):
        ...
        sender.setStyleSheet(OTROS['principal_sender'])
        if boton_actual != self.ultimo_boton_seleccionado:
            if self.ultimo_boton_seleccionado:
                ...
                self.ultimo_boton_seleccionado.setStyleSheet(BOTONES['principal_ultimo_boton_seleccionado'])
        ...
        if sender.text() == "Registro de ingresos":
            ...
            self.pagina_casilleros.senalActualizarComboboxPcs.emit()
