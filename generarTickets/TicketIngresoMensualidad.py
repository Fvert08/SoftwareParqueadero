...
def generarTicketIngresoMensualidad(codigo,Fecha, Hora,Nombre,Placa,Telefono):
    # Obtener la ruta del directorio actual
    directorio_actual = os.path.dirname(os.path.abspath(__file__))
    ruta_logo = os.path.join(directorio_actual,"..", "imagenes","Logo.png")
    ruta_guardado = os.path.join(directorio_actual,"..", "Tickets","TicketIngresoMensualidad.png")
...
def imprimirTicket(ruta_archivo):
    try:
        ...
        try:
            ...
            hJob = win32print.StartDocPrinter(hPrinter, 1, ("TicketIngresoMensualidad", None, "RAW"))
            try:
                ...
                hDC.StartDoc("TicketIngresoMensualidad")
                hDC.StartPage()
