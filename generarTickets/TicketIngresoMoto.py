...
def generarTicketIngresoMoto(codigo,Tipo, Placa, Cascos, Casillero, Fecha, Hora):
    ...
    ruta_guardado = os.path.join(directorio_actual, "..","Tickets","TicketIngresoMoto.png")
...
def imprimirTicket(ruta_archivo):
    try:
        ...
        try:
            ...
            hJob = win32print.StartDocPrinter(hPrinter, 1, ("TicketIngresoMoto", None, "RAW"))
            try:
                ...
                hDC.StartDoc("TicketIngresoMoto")
                hDC.StartPage()
