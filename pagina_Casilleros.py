...
class PaginaCasilleros(QWidget):
    ...
    def initUI(self):
        ...
        titulo_casilleros.setStyleSheet(STYLES['pagina_Casilleros.py:96'])
        ...
        linea_horizontal1.setStyleSheet(STYLES['pagina_Casilleros.py:103'])
        layout_tickets.addWidget(linea_horizontal1, 1, 0, 1, 10)

        titulo_tablacasilleros = QLabel('CASILLEROS')
        titulo_tablacasilleros.setStyleSheet(STYLES['pagina_Casilleros.py:107'])
        ...
        titulo_agregarCasillero.setStyleSheet(STYLES['pagina_Casilleros.py:111'])
        ...
        titulo_numero .setStyleSheet(STYLES['pagina_Casilleros.py:115'])
        layout_tickets.addWidget(titulo_numero , 8, 0, 1, 1, alignment= Qt.AlignBottom |Qt.AlignHCenter)

        textbox_numero = QLineEdit()
        textbox_numero.setStyleSheet(STYLES['pagina_Casilleros.py:119'])
        ...
        titulo_pc = QLabel('PC')
        titulo_pc.setStyleSheet(STYLES['pagina_Casilleros.py:124'])
        layout_tickets.addWidget(titulo_pc , 8, 2, 1, 1, alignment= Qt.AlignBottom |Qt.AlignHCenter)

        self.combobox_pcRegistro = QComboBox()
        self.combobox_pcRegistro.setStyleSheet(STYLES['pagina_Casilleros.py:128'])
        ...
        titulo_estado .setStyleSheet(STYLES['pagina_Casilleros.py:132'])
        ...
        combobox_Estado.setStyleSheet(STYLES['pagina_Casilleros.py:137'])
        layout_tickets.addWidget(combobox_Estado,9, 1, 1, 1, alignment= Qt.AlignCenter |Qt.AlignHCenter)

        boton_agregar = QPushButton('AGREGAR')
        boton_agregar.setStyleSheet(STYLES['pagina_Casilleros.py:141'])
        ...
        self.tabla_registrosCasillero.setStyleSheet(STYLES['pagina_Casilleros.py:161'])
        ...
        boton_desocupar.setStyleSheet(STYLES['pagina_Casilleros.py:215'])
        ...
        boton_eliminar.setStyleSheet(STYLES['pagina_Casilleros.py:229'])
        ...
        titulo_cambiarPc .setStyleSheet(STYLES['pagina_Casilleros.py:244'])
        layout_tickets.addWidget(titulo_cambiarPc, 5, 4, 1, 2,
                                alignment=Qt.AlignBottom| Qt.AlignHCenter)
        
        titulo_pcCambiar = QLabel('PC')
        titulo_pcCambiar.setStyleSheet(STYLES['pagina_Casilleros.py:249'])
        ...
        self.combobox_pcCambiar.setStyleSheet(STYLES['pagina_Casilleros.py:254'])
        ...
        boton_guardarPc.setStyleSheet(STYLES['pagina_Casilleros.py:258'])
        ...
        titulo_tablaOrdenDeLlegada.setStyleSheet(STYLES['pagina_Casilleros.py:273'])
        ...
        self.tablaOrdenDeLlenado.setStyleSheet(STYLES['pagina_Casilleros.py:280'])
        ...
        boton_subir.setStyleSheet(STYLES['pagina_Casilleros.py:333'])
        ...
        boton_bajar.setStyleSheet(STYLES['pagina_Casilleros.py:346'])
