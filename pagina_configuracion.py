...
class PaginaConfiguracion(QWidget):
    ...
    def pantallaValoresFacturacion(self):
        ...
        titulo_CambiarValores.setStyleSheet(TITULO_SECCION)
        ...
        titulo_usuariosAgregados .setStyleSheet(TITULO_BLANCO_30)
        ...
        titulo_hora.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textbox_horaFacturacion.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_dia.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textbox_diaFecturacion.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_mes.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textbox_mesFacturacion.setStyleSheet(CAMPO_TEXTO_30)
        ...
        boton_aceptar.setStyleSheet(boton_formulario(25, "10px 20px"))
    ...
    def pantallaValidarAcceso(self):
        ...
        titulo_validar.setStyleSheet(TITULO_SECCION)
        ...
        titulo_ContraseñaAcceso.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textbox_ContraseñaAcceso.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.boton_OcultarContrasena.setStyleSheet(BOTON_FORMULARIO_DARK)
        ...
        boton_validar.setStyleSheet(boton_formulario(35, "10px 20px"))
    ...
    def pantallaPC(self):
        ...
        # Crear el título y añadirlo a la sección izquierda
        titulo_ = QLabel('PC')
        titulo_.setStyleSheet(TITULO_SECCION)
        ...
        titulo_PcAgregados.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.tabla_PCAgregados.setStyleSheet(TABLA_ESTANDAR)
        ...
        boton_editar .setStyleSheet(boton_formulario(25, "10px 20px"))
        ...
        boton_eliminar.setStyleSheet(boton_formulario(25, "10px 20px"))
    ...
    def pantallaSuscripcion(self):
        ...
        titulo_Suscripcion.setStyleSheet(TITULO_SECCION)
        ...
        textbox_Codigo.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_EstadoActual .setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxEstadoActualSuscripcion.setStyleSheet(CAMPO_TEXTO_VERDE_30)
        ...
        tituloDiasRestantesSuscripción .setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxDiasRestantesSuscripcion.setStyleSheet(CAMPO_TEXTO_30)
    ...
    def _menu_lateral_style(self):
        return boton_lateral(25, "10px 20px", negrita=True)
