...
class PaginaTickets(QWidget):
    ...
    def initUI(self):
        ...
        linea_horizontal2.setStyleSheet(LINEAS['tickets_linea_horizontal2'])
        ...
        boton_IngresarM.setStyleSheet(BOTONES['tickets_boton_ingresar_m'])
        ...
        boton_SacarM.setStyleSheet(BOTONES['tickets_boton_sacar_m'])
        ...
        boton_IngresarF.setStyleSheet(BOTONES['tickets_boton_ingresar_f'])
        ...
        boton_SacarF.setStyleSheet(BOTONES['tickets_boton_sacar_f'])
        ...
        boton_IngresarMensualidad.setStyleSheet(BOTONES['tickets_boton_ingresar_mensualidad'])
        ...
        boton_SacarMensualidad.setStyleSheet(BOTONES['tickets_boton_sacar_mensualidad'])
    ...
    def pantallaIngresoMotos (self):
        ...
        titulo_tickets.setStyleSheet(LABELS['tickets_titulo_tickets'])
        ...
        label_cascos.setStyleSheet(LABELS['tickets_label_cascos'])
        ...
        self.combobox_cascos.setStyleSheet(COMBOBOX['tickets_combobox_cascos'])
        ...
        label_Tiempo.setStyleSheet(LABELS['tickets_label_tiempo'])
        ...
        combobox_Tiempo.setStyleSheet(COMBOBOX['tickets_combobox_tiempo'])
        ...
        checkbox_opcion.setStyleSheet(CHECKBOXES['tickets_checkbox_opcion'])
        ...
        label_casillero.setStyleSheet(LABELS['tickets_label_casillero'])
        ...
        self.textbox_casillero.setStyleSheet(INPUTS['tickets_textbox_casillero'])
        ...
        boton_cambiarcasillero.setStyleSheet(BOTONES['tickets_boton_cambiarcasillero'])
        ...
        label_casillerosDis.setStyleSheet(LABELS['tickets_label_casilleros_dis'])
        ...
        self.textbox_casillerosDis.setStyleSheet(INPUTS['tickets_textbox_casilleros_dis'])
        ...
        self.botonImprimirRegistroMoto.setStyleSheet(BOTONES['tickets_boton_imprimir_registro_moto'])
    ...
    def pantallaSacarMoto (self):
        ...
        titulo_tickets.setStyleSheet(LABELS['tickets_titulo_tickets_2'])
        ...
        linea_horizontal1.setFrameShape(QFrame.HLine)
        linea_horizontal1.setLineWidth(1)
        linea_horizontal1.setStyleSheet(LINEAS['tickets_linea_horizontal1_2'])
        ...
        label_codigo.setStyleSheet(LABELS['tickets_label_codigo'])
        ...
        self.textboxCodigoSacarMoto.setStyleSheet(INPUTS['tickets_textbox_codigo_sacar_moto'])
        ...
        # Crear el label "Placa" y la textbox
        label_placa = QLabel('Placa:')
        label_placa.setStyleSheet(LABELS['tickets_label_placa_2'])
        ...
        self.textboxPlacaSacarMoto.setStyleSheet(INPUTS['tickets_textbox_placa_sacar_moto'])
        ...
        boton_buscar.setStyleSheet(BOTONES['tickets_boton_buscar'])
...
#----Mostrar---
    #---Fila 1
        ...
        label_casillero.setStyleSheet(LABELS['tickets_label_casillero_2'])
        ...
        self.textboxCasilleroSacarMoto.setStyleSheet(INPUTS['tickets_textbox_casillero_sacar_moto'])
        ...
        label_cascos = QLabel('Cascos')
        label_cascos.setStyleSheet(LABELS['tickets_label_cascos_2'])
        ...
        self.textboxCascosSacarMoto.setStyleSheet(INPUTS['tickets_textbox_cascos_sacar_moto'])
     ...
     #---Fila 2
        ...
        label_FIngreso.setStyleSheet(LABELS['tickets_label_f_ingreso'])
        ...
        self.textboxFIngresoSacarMoto.setStyleSheet(INPUTS['tickets_textbox_f_ingreso_sacar_moto'])
        ...
        label_HIngreso.setStyleSheet(LABELS['tickets_label_h_ingreso'])
        ...
        self.textboxHIngresoSacarMoto.setStyleSheet(INPUTS['tickets_textbox_h_ingreso_sacar_moto'])
    ...
    #---Fila 3
        ...
        label_FSalida.setStyleSheet(LABELS['tickets_label_f_salida'])
        ...
        self.textboxFSalidaSacarMoto.setStyleSheet(INPUTS['tickets_textbox_f_salida_sacar_moto'])
        ...
        label_HSalida.setStyleSheet(LABELS['tickets_label_h_salida'])
        ...
        self.textboxHSalidaSacarMoto.setStyleSheet(INPUTS['tickets_textbox_h_salida_sacar_moto'])
    ...
    #---Fila 4
        ...
        label_PagadoPor.setStyleSheet(LABELS['tickets_label_pagado_por'])
        ...
        self.textboxPagadoPorSacarMoto.setStyleSheet(INPUTS['tickets_textbox_pagado_por_sacar_moto'])
        ...
        label_TiempoTotal.setStyleSheet(LABELS['tickets_label_tiempo_total'])
        ...
        self.textboxTiempoTotalSacarMoto.setStyleSheet(INPUTS['tickets_textbox_tiempo_total_sacar_moto'])
...
#----Facturar
        ...
        label_TotalAPagar.setStyleSheet(LABELS['tickets_label_total_a_pagar'])
        ...
        self.textboxTotalAPagarSacarMoto.setStyleSheet(INPUTS['tickets_textbox_total_a_pagar_sacar_moto'])
        ...
        self.boton_facturar.setStyleSheet(BOTONES['tickets_boton_facturar'])
    ...
    def pantallaIngresarFijo(self):
        ...
        titulo_tickets.setStyleSheet(LABELS['tickets_titulo_tickets_3'])
        ...
        linea_horizontal1.setFrameShape(QFrame.HLine)
        linea_horizontal1.setLineWidth(1)
        linea_horizontal1.setStyleSheet(LINEAS['tickets_linea_horizontal1_3'])
        layout_ticketsIngresoFijo.addWidget(linea_horizontal1, 1, 0, 1, 7)
    #---Fila 1
        # Crear el label "Codigo" y la textbox
        label_codigo = QLabel('Codigo')
        label_codigo.setStyleSheet(LABELS['tickets_label_codigo_2'])
        layout_ticketsIngresoFijo.addWidget(label_codigo, 2, 2, 1, 1)
        # Text box Codigo 
        self.textbox_codigoFijos = QLineEdit()
        self.textbox_codigoFijos.setStyleSheet(INPUTS['tickets_textbox_codigo_fijos'])
    ...
    #---Fila 2
        ...
        label_tipo.setStyleSheet(LABELS['tickets_label_tipo'])
        ...
        combobox_Tipo.setStyleSheet(COMBOBOX['tickets_combobox_tipo'])
    ...
    #---Fila 5
        ...
        boton_Imprimir.setStyleSheet(BOTONES['tickets_boton_imprimir'])
    ...
    def pantallaSacarFijo(self):
        ...
        titulo_tickets.setStyleSheet(LABELS['tickets_titulo_tickets_4'])
        ...
        linea_horizontal1.setFrameShape(QFrame.HLine)
        linea_horizontal1.setLineWidth(1)
        linea_horizontal1.setStyleSheet(LINEAS['tickets_linea_horizontal1_4'])
        layout_ticketsSacarFijo.addWidget(linea_horizontal1, 0, 0, 1, 7, alignment=Qt.AlignBottom)
    #---Buscar
        # Crear el label "Codigo" y la textbox
        label_codigo = QLabel('Codigo')
        label_codigo.setStyleSheet(LABELS['tickets_label_codigo_3'])
        ...
        self.textboxCodigoFijo.setStyleSheet(INPUTS['tickets_textbox_codigo_fijo'])
        ...
        botonBuscarFijos.setStyleSheet(BOTONES['tickets_boton_buscar_fijos'])
    ...
    #---Fila 1
        # Crear el label "Tipo" y la textbox
        label_Tipo = QLabel('Tipo')
        label_Tipo.setStyleSheet(LABELS['tickets_label_tipo_2'])
        ...
        self.textboxTipoFijos.setStyleSheet(INPUTS['tickets_textbox_tipo_fijos'])
        ...
        # Crear el label "Nota" y la textbox
        label_Nota = QLabel('Nota')
        label_Nota.setStyleSheet(LABELS['tickets_label_nota_2'])
        ...
        self.textboxNotaFijos.setStyleSheet(INPUTS['tickets_textbox_nota_fijos'])
     ...
     #---Fila 2
        # Crear el label "Fecha ingreso" y la textbox
        label_FIngreso = QLabel('Fecha ingreso')
        label_FIngreso.setStyleSheet(LABELS['tickets_label_f_ingreso_2'])
        ...
        self.textboxFIngresoFijos.setStyleSheet(INPUTS['tickets_textbox_f_ingreso_fijos'])
        ...
        # Crear el label "Hora ingreso" y la textbox
        label_HIngreso = QLabel('Hora ingreso')
        label_HIngreso.setStyleSheet(LABELS['tickets_label_h_ingreso_2'])
        ...
        self.textboxHIngresoFijos.setStyleSheet(INPUTS['tickets_textbox_h_ingreso_fijos'])
    ...
    #---Fila 3
        # Crear el label "Fecha salida" y la textbox
        label_FSalida= QLabel('Fecha salida')
        label_FSalida.setStyleSheet(LABELS['tickets_label_f_salida_2'])
        ...
        self.textboxFSalidaFijos.setStyleSheet(INPUTS['tickets_textbox_f_salida_fijos'])
        ...
        # Crear el label "Hora salida" y la textbox
        label_HSalida = QLabel('Hora salida')
        label_HSalida.setStyleSheet(LABELS['tickets_label_h_salida_2'])
        ...
        self.textboxHSalidaFijos.setStyleSheet(INPUTS['tickets_textbox_h_salida_fijos'])
    ...
    #---Fila 4
        # Crear el label "Tiempo total" y la textbox
        label_TiempoTotal = QLabel('Tiempo total')
        label_TiempoTotal.setStyleSheet(LABELS['tickets_label_tiempo_total_2'])
        ...
        self.textboxTiempoTotalFijos.setStyleSheet(INPUTS['tickets_textbox_tiempo_total_fijos'])
        ...
        # Crear el label "Total a pagar" y la textbox
        label_TotalApagar= QLabel('Total a pagar')
        label_TotalApagar.setStyleSheet(LABELS['tickets_label_total_apagar'])
        ...
        self.textboxTotalApagarFijos.setStyleSheet(INPUTS['tickets_textbox_total_apagar_fijos'])
        ...
        self.botonfacturarFijos.setStyleSheet(BOTONES['tickets_botonfacturar_fijos'])
    ...
    def pantallaIngresarMensualidad(self):
        ...
        titulo_tickets.setStyleSheet(LABELS['tickets_titulo_tickets_5'])
        ...
        textbox_Nombre.setStyleSheet(INPUTS['tickets_textbox_nombre'])
        ...
        titulo_Telefono .setStyleSheet(LABELS['tickets_titulo_telefono'])
        ...
        textbox_Telefono.setStyleSheet(INPUTS['tickets_textbox_telefono'])
        ...
        titulo_MensualidadesVigentes .setStyleSheet(LABELS['tickets_titulo_mensualidades_vigentes'])
        ...
        self.textbox_MensualidadesVigentes.setStyleSheet(INPUTS['tickets_textbox_mensualidades_vigentes'])
        ...
        #Boton Imprimir
        boton_imprimir = QPushButton('IMPRIMIR')
        boton_imprimir.setStyleSheet(BOTONES['tickets_boton_imprimir_2'])
    ...
    def pantallaRenovarMensualidad(self):
        ...
        titulo_tickets.setStyleSheet(LABELS['tickets_titulo_tickets_6'])
        ...
        linea_horizontal1.setFrameShape(QFrame.HLine)
        linea_horizontal1.setLineWidth(1)
        linea_horizontal1.setStyleSheet(LINEAS['tickets_linea_horizontal1_6'])
        layout_ticketsRenovarMensualidad.addWidget(linea_horizontal1, 1, 0, 1, 7)

        #Codigo
        titulo_Codigo = QLabel('CODIGO')
        titulo_Codigo.setStyleSheet(LABELS['tickets_titulo_codigo'])
        ...
        self.textboxCodigoRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_codigo_renovar_mensualidad'])
        ...
        #Placa
        titulo_Placa = QLabel('PLACA')
        titulo_Placa .setStyleSheet(LABELS['tickets_titulo_placa_2'])
        ...
        self.textboxPlacaRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_placa_renovar_mensualidad'])
        ...
        self.botonBuscarRenovarMensualidad.setStyleSheet(BOTONES['tickets_boton_buscar_renovar_mensualidad'])
        ...
        #Nombre
        titulo_Nombre = QLabel('NOMBRE')
        titulo_Nombre.setStyleSheet(LABELS['tickets_titulo_nombre_2'])
        ...
        self.textboxNombreRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_nombre_renovar_mensualidad'])
        ...
        titulo_FechaIngreso.setStyleSheet(LABELS['tickets_titulo_fecha_ingreso'])
        ...
        self.textboxFechaIngresoRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_fecha_ingreso_renovar_mensualidad'])
        ...
        titulo_FechaUPago.setStyleSheet(LABELS['tickets_titulo_fecha_u_pago'])
        ...
        self.textboxFechaUPagoRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_fecha_u_pago_renovar_mensualidad'])
        ...
        titulo_FechaRenovacion.setStyleSheet(LABELS['tickets_titulo_fecha_renovacion'])
        ...
        self.textboxFechaRenovacionRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_fecha_renovacion_renovar_mensualidad'])
        ...
        #Telefono
        titulo_Telefono = QLabel('TELEFONO')
        titulo_Telefono.setStyleSheet(LABELS['tickets_titulo_telefono_2'])
        ...
        self.textboxTelefonoRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_telefono_renovar_mensualidad'])
        ...
        titulo_HoraIngreso.setStyleSheet(LABELS['tickets_titulo_hora_ingreso'])
        ...
        self.textboxHoraIngresoRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_hora_ingreso_renovar_mensualidad'])
        ...
        titulo_HoraUPago.setStyleSheet(LABELS['tickets_titulo_hora_u_pago'])
        ...
        self.textboxHoraUPagoRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_hora_u_pago_renovar_mensualidad'])
        ...
        titulo_TotalAPagar.setStyleSheet(LABELS['tickets_titulo_total_a_pagar'])
        ...
        self.textboxTotalAPagarRenovarMensualidad.setStyleSheet(INPUTS['tickets_textbox_total_a_pagar_renovar_mensualidad'])
        ...
        self.botonRenovarMensualidad.setStyleSheet(BOTONES['tickets_boton_renovar_mensualidad'])
        # Conectar el botón de imprimir a la función registrarMoto
