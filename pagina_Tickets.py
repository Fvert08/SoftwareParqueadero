...
class PaginaTickets(QWidget):
    ...
    def initUI(self):
        ...
        linea_horizontal2.setStyleSheet(LINEA_BLANCA)
    ...
    def _menu_lateral_style(self):
        return boton_lateral(30, "10px 10px", negrita=False)
    ...
    def pantallaIngresoMotos (self):
        ...
        titulo_tickets.setStyleSheet(TITULO_SECCION_25)
        ...
        label_cascos.setStyleSheet(TEXTO_BLANCO_40)
        ...
        self.combobox_cascos.setStyleSheet(CAMPO_TEXTO_40)
        ...
        label_Tiempo.setStyleSheet(TEXTO_BLANCO_40)
        ...
        combobox_Tiempo.setStyleSheet(CAMPO_TEXTO_40)
        ...
        checkbox_opcion.setStyleSheet(TEXTO_BLANCO_20)
        ...
        label_casillero.setStyleSheet(TEXTO_BLANCO_40)
        ...
        self.textbox_casillero.setStyleSheet(CAMPO_TEXTO_30)
        ...
        boton_cambiarcasillero.setStyleSheet(boton_formulario_presion(15, "15px 30px", deshabilitado=True))
        ...
        label_casillerosDis.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textbox_casillerosDis.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.botonImprimirRegistroMoto.setStyleSheet(boton_formulario_presion(30, "15px 30px", deshabilitado=True))
    ...
    def pantallaSacarMoto (self):
        ...
        titulo_tickets.setStyleSheet(TITULO_SECCION)
        ...
        label_codigo.setStyleSheet(TEXTO_BLANCO_40)
        ...
        self.textboxCodigoSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.textboxPlacaSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        boton_buscar.setStyleSheet(boton_formulario_presion(30, "15px 30px", deshabilitado=False))
...
#----Mostrar---
    #---Fila 1
        ...
        label_casillero.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxCasilleroSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        label_cascos = QLabel('Cascos')
        label_cascos.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxCascosSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
     ...
     #---Fila 2
        ...
        label_FIngreso.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxFIngresoSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        label_HIngreso.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxHIngresoSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
    ...
    #---Fila 3
        ...
        label_FSalida.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxFSalidaSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        label_HSalida.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxHSalidaSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
    ...
    #---Fila 4
        ...
        label_PagadoPor.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxPagadoPorSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        label_TiempoTotal.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxTiempoTotalSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
...
#----Facturar
        ...
        label_TotalAPagar.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxTotalAPagarSacarMoto.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.boton_facturar.setStyleSheet(boton_formulario_presion(30, "15px 30px", deshabilitado=True))
    ...
    #---Fila 1
        ...
        self.textbox_codigoFijos.setStyleSheet(CAMPO_TEXTO_30)
    ...
    #---Fila 2
        ...
        label_tipo.setStyleSheet(TEXTO_BLANCO_40)
        ...
        combobox_Tipo.setStyleSheet(CAMPO_TEXTO_40)
    ...
    #---Fila 5
        ...
        self.botonImprimirFijo.setStyleSheet(boton_formulario_presion(30, "15px 30px", deshabilitado=True))
    ...
    #---Buscar
        # Crear el label "Codigo" y la textbox
        label_codigo = QLabel('Codigo')
        label_codigo.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxCodigoFijo.setStyleSheet(CAMPO_TEXTO_30)
        ...
        botonBuscarFijos.setStyleSheet(boton_formulario_presion(30, "15px 30px", deshabilitado=False))
    ...
    #---Fila 1
        # Crear el label "Tipo" y la textbox
        label_Tipo = QLabel('Tipo')
        label_Tipo.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxTipoFijos.setStyleSheet(CAMPO_TEXTO_30)
        ...
        # Crear el label "Nota" y la textbox
        label_Nota = QLabel('Nota')
        label_Nota.setStyleSheet(TEXTO_BLANCO_30)
        ...
        self.textboxNotaFijos.setStyleSheet(CAMPO_TEXTO_30)
     ...
     #---Fila 2
        ...
        self.textboxFIngresoFijos.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.textboxHIngresoFijos.setStyleSheet(CAMPO_TEXTO_30)
    ...
    #---Fila 3
        ...
        self.textboxFSalidaFijos.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.textboxHSalidaFijos.setStyleSheet(CAMPO_TEXTO_30)
    ...
    #---Fila 4
        ...
        self.textboxTiempoTotalFijos.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.textboxTotalApagarFijos.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.botonfacturarFijos.setStyleSheet(boton_formulario_presion(30, "15px 30px", deshabilitado=True))
    ...
    def pantallaIngresarMensualidad(self):
        ...
        titulo_Placa .setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxPlacaMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_Nombre .setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxNombreMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_Telefono .setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxTelefonoMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_MensualidadesVigentes .setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textbox_MensualidadesVigentes.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.botonImprimirMensualidad.setStyleSheet(boton_formulario_presion(35, "10px 20px", deshabilitado=True))
    ...
    def pantallaRenovarMensualidad(self):
        ...
        titulo_Codigo.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxCodigoRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.textboxPlacaRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.botonBuscarRenovarMensualidad.setStyleSheet(boton_formulario(25, "10px 20px"))
        ...
        self.textboxNombreRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_FechaIngreso.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxFechaIngresoRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_FechaUPago.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxFechaUPagoRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_FechaRenovacion.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxFechaRenovacionRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.textboxTelefonoRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_HoraIngreso.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxHoraIngresoRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_HoraUPago.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxHoraUPagoRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        titulo_TotalAPagar.setStyleSheet(TITULO_BLANCO_30)
        ...
        self.textboxTotalAPagarRenovarMensualidad.setStyleSheet(CAMPO_TEXTO_30)
        ...
        self.botonRenovarMensualidad.setStyleSheet(boton_formulario_presion(30, "10px 20px", deshabilitado=True))
        # Conectar el botón de imprimir a la función registrarMoto
